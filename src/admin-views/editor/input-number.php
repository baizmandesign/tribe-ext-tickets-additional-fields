...
<?php endif; ?>
	...
	<input type="number" id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo esc_attr( $field_id ); ?>"
	       class="ticket_field ticket_form_right" value="<?php echo esc_attr( $field_value ); ?>">
